...
// GetVideoStreamByContainerOperationResponse is the result of GetVideoStreamByContainer.
//
// The operation answers video/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetVideoStreamByContainerOperationResponse struct {
	HttpResponse *http.Response
}

// GetVideoStreamByContainerOperationOptions holds the query and header parameters of GetVideoStreamByContainer.
type GetVideoStreamByContainerOperationOptions struct {
...
func (o GetVideoStreamByContainerOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetVideoStreamByContainerOperationOptions) ToQuery() *client.QueryParams {
