...
// GetStudioImageOperationResponse is the result of GetStudioImage.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetStudioImageOperationResponse struct {
	HttpResponse *http.Response
}

// GetStudioImageOperationOptions holds the query and header parameters of GetStudioImage.
type GetStudioImageOperationOptions struct {
...
func (o GetStudioImageOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetStudioImageOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetStudioImage(ctx context.Context, name string, imageType ImageType, options GetStudioImageOperationOptions) (result GetStudioImageOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Studios/%s/Images/%s", url.PathEscape(name), url.PathEscape(string(imageType))),
		StreamResponse: true,
	}
