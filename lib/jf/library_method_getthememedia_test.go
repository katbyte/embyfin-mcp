...
func TestOperationGetThemeMedia(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetThemeMedia(t.Context(), "p/itemId", GetThemeMediaOperationOptions{
		UserId:            "v-UserId",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Items/p%2FitemId/ThemeMedia")
