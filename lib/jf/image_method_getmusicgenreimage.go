...
// GetMusicGenreImageOperationResponse is the result of GetMusicGenreImage.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetMusicGenreImageOperationResponse struct {
	HttpResponse *http.Response
}

// GetMusicGenreImageOperationOptions holds the query and header parameters of GetMusicGenreImage.
type GetMusicGenreImageOperationOptions struct {
...
func (o GetMusicGenreImageOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetMusicGenreImageOperationOptions) ToQuery() *client.QueryParams {
