...
// GetStudioImageByIndexOperationResponse is the result of GetStudioImageByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetStudioImageByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetStudioImageByIndexOperationOptions holds the query and header parameters of GetStudioImageByIndex.
type GetStudioImageByIndexOperationOptions struct {
...
func (o GetStudioImageByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetStudioImageByIndexOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetStudioImageByIndex(ctx context.Context, name string, imageType ImageType, imageIndex int, options GetStudioImageByIndexOperationOptions) (result GetStudioImageByIndexOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Studios/%s/Images/%s/%d", url.PathEscape(name), url.PathEscape(string(imageType)), imageIndex),
		StreamResponse: true,
	}
