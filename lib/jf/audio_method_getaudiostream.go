...
// GetAudioStreamOperationResponse is the result of GetAudioStream.
//
// The operation answers audio/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetAudioStreamOperationResponse struct {
	HttpResponse *http.Response
}

// GetAudioStreamOperationOptions holds the query and header parameters of GetAudioStream.
type GetAudioStreamOperationOptions struct {
	// The audio container.
	Container string
...
func (o GetAudioStreamOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAudioStreamOperationOptions) ToQuery() *client.QueryParams {
