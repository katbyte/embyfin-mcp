...
func TestOperationGetMusicGenreImageByIndex(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "image/png", "file bytes")
	result, err := c.GetMusicGenreImageByIndex(t.Context(), "p/name", ImageTypePrimary, 7, GetMusicGenreImageByIndexOperationOptions{
		Tag:             "v-Tag",
