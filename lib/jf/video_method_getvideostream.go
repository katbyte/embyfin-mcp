...
// GetVideoStreamOperationResponse is the result of GetVideoStream.
//
// The operation answers video/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetVideoStreamOperationResponse struct {
	HttpResponse *http.Response
}

// GetVideoStreamOperationOptions holds the query and header parameters of GetVideoStream.
type GetVideoStreamOperationOptions struct {
...
func (o GetVideoStreamOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetVideoStreamOperationOptions) ToQuery() *client.QueryParams {
