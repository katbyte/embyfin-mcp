...
// GetArtistImageOperationResponse is the result of GetArtistImage.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetArtistImageOperationResponse struct {
	HttpResponse *http.Response
}

// GetArtistImageOperationOptions holds the query and header parameters of GetArtistImage.
type GetArtistImageOperationOptions struct {
...
func (o GetArtistImageOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetArtistImageOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetArtistImage(ctx context.Context, name string, imageType ImageType, imageIndex int, options GetArtistImageOperationOptions) (result GetArtistImageOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Artists/%s/Images/%s/%d", url.PathEscape(name), url.PathEscape(string(imageType)), imageIndex),
		StreamResponse: true,
	}
