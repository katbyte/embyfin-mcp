...
func TestOperationGetGenreImageByIndex(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "image/png", "file bytes")
	result, err := c.GetGenreImageByIndex(t.Context(), "p/name", ImageTypePrimary, 7, GetGenreImageByIndexOperationOptions{
		Tag:             "v-Tag",
