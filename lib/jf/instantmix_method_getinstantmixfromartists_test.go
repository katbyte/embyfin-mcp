...
func TestOperationGetInstantMixFromArtists(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetInstantMixFromArtists(t.Context(), "p/itemId", GetInstantMixFromArtistsOperationOptions{
		UserId:           "v-UserId",
		Limit:            7,
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Artists/p%2FitemId/InstantMix")
