...
// GetPersonImageByIndexOperationResponse is the result of GetPersonImageByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetPersonImageByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetPersonImageByIndexOperationOptions holds the query and header parameters of GetPersonImageByIndex.
type GetPersonImageByIndexOperationOptions struct {
...
func (o GetPersonImageByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetPersonImageByIndexOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetPersonImageByIndex(ctx context.Context, name string, imageType ImageType, imageIndex int, options GetPersonImageByIndexOperationOptions) (result GetPersonImageByIndexOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Persons/%s/Images/%s/%d", url.PathEscape(name), url.PathEscape(string(imageType)), imageIndex),
		StreamResponse: true,
	}
