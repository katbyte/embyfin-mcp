...
// GetGenreImageByIndexOperationResponse is the result of GetGenreImageByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetGenreImageByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetGenreImageByIndexOperationOptions holds the query and header parameters of GetGenreImageByIndex.
type GetGenreImageByIndexOperationOptions struct {
...
func (o GetGenreImageByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetGenreImageByIndexOperationOptions) ToQuery() *client.QueryParams {
