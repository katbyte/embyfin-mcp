...
func TestOperationUpdateDisplayPreferences(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 204, "", "")
	result, err := c.UpdateDisplayPreferences(t.Context(), "p/displayPreferencesId", DisplayPreferencesDto{}, UpdateDisplayPreferencesOperationOptions{
		UserId: "v-UserId",
		Client: "v-Client",
	})
	if err != nil {
