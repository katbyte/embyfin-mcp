...
// GetPersonImageOperationResponse is the result of GetPersonImage.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetPersonImageOperationResponse struct {
	HttpResponse *http.Response
}

// GetPersonImageOperationOptions holds the query and header parameters of GetPersonImage.
type GetPersonImageOperationOptions struct {
...
func (o GetPersonImageOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetPersonImageOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetPersonImage(ctx context.Context, name string, imageType ImageType, options GetPersonImageOperationOptions) (result GetPersonImageOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Persons/%s/Images/%s", url.PathEscape(name), url.PathEscape(string(imageType))),
		StreamResponse: true,
	}
