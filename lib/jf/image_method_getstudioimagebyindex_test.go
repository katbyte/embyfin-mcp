...
func TestOperationGetStudioImageByIndex(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "image/png", "file bytes")
	result, err := c.GetStudioImageByIndex(t.Context(), "p/name", ImageTypePrimary, 7, GetStudioImageByIndexOperationOptions{
		Tag:             "v-Tag",
