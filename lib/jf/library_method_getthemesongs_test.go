...
func TestOperationGetThemeSongs(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetThemeSongs(t.Context(), "p/itemId", GetThemeSongsOperationOptions{
		UserId:            "v-UserId",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Items/p%2FitemId/ThemeSongs")
