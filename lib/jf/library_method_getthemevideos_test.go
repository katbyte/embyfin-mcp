...
func TestOperationGetThemeVideos(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetThemeVideos(t.Context(), "p/itemId", GetThemeVideosOperationOptions{
		UserId:            "v-UserId",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Items/p%2FitemId/ThemeVideos")
