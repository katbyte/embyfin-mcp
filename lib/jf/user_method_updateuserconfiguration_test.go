...
func TestOperationUpdateUserConfiguration(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 204, "", "")
	result, err := c.UpdateUserConfiguration(t.Context(), UserConfiguration{}, UpdateUserConfigurationOperationOptions{
		UserId: "v-UserId",
	})
	if err != nil {
		t.Fatal(err)
