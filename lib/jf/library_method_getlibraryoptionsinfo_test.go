...
func TestOperationGetLibraryOptionsInfo(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetLibraryOptionsInfo(t.Context(), GetLibraryOptionsInfoOperationOptions{
		LibraryContentType: CollectionTypeUnknown,
	...
	expectQuery(t, r, "libraryContentType", "unknown")
