...
// Package jf is a typed client for Jellyfin API 12.1.0, generated by internal/pandorest
// from the definitions in api-defs/jellyfin-12.1.0, which were imported from api-defs/jellyfin-openapi-12.1.0.json.
//
// # Layout
//
