...
// GetItemImageByIndexOperationResponse is the result of GetItemImageByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetItemImageByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetItemImageByIndexOperationOptions holds the query and header parameters of GetItemImageByIndex.
type GetItemImageByIndexOperationOptions struct {
...
func (o GetItemImageByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemImageByIndexOperationOptions) ToQuery() *client.QueryParams {
