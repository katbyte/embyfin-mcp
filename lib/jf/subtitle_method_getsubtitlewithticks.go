...
// GetSubtitleWithTicksOperationResponse is the result of GetSubtitleWithTicks.
//
// The operation answers text/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetSubtitleWithTicksOperationResponse struct {
	HttpResponse *http.Response
}

// GetSubtitleWithTicksOperationOptions holds the query and header parameters of GetSubtitleWithTicks.
type GetSubtitleWithTicksOperationOptions struct {
	// The item id.
	//
...
func (o GetSubtitleWithTicksOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetSubtitleWithTicksOperationOptions) ToQuery() *client.QueryParams {
