...
func TestOperationGetPersonImageByIndex(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "image/png", "file bytes")
	result, err := c.GetPersonImageByIndex(t.Context(), "p/name", ImageTypePrimary, 7, GetPersonImageByIndexOperationOptions{
		Tag:             "v-Tag",
