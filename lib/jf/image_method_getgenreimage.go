...
// GetGenreImageOperationResponse is the result of GetGenreImage.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetGenreImageOperationResponse struct {
	HttpResponse *http.Response
}

// GetGenreImageOperationOptions holds the query and header parameters of GetGenreImage.
type GetGenreImageOperationOptions struct {
...
func (o GetGenreImageOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetGenreImageOperationOptions) ToQuery() *client.QueryParams {
