...
func TestOperationAccountWatchlistMovies(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.AccountWatchlistMovies(t.Context(), 7, AccountWatchlistMoviesOperationOptions{
		Language:  "v-Language",
		Page:      new(7),
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/3/account/7/watchlist/movies")
