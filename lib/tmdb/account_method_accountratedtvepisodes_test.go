...
func TestOperationAccountRatedTvEpisodes(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.AccountRatedTvEpisodes(t.Context(), 7, AccountRatedTvEpisodesOperationOptions{
		Language:  "v-Language",
		Page:      new(7),
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/3/account/7/rated/tv/episodes")
