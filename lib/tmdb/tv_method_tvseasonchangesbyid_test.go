...
func TestOperationTvSeasonChangesById(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.TvSeasonChangesById(t.Context(), 7, TvSeasonChangesByIdOperationOptions{
		EndDate:   "v-EndDate",
		Page:      new(7),
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/3/tv/season/7/changes")
	expectQuery(t, r, "end_date", "v-EndDate")
	expectQuery(t, r, "page", "7")
	expectQuery(t, r, "start_date", "v-StartDate")
