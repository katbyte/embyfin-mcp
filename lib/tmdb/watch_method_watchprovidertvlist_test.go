...
func TestOperationWatchProviderTvList(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.WatchProviderTvList(t.Context(), WatchProviderTvListOperationOptions{
		Language:    "v-Language",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/3/watch/providers/tv")
