...
func TestOperationListCheckItemStatus(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.ListCheckItemStatus(t.Context(), 7, ListCheckItemStatusOperationOptions{
		Language: "v-Language",
		MovieId:  7,
	})
	if err != nil {
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/3/list/7/item_status")
	expectQuery(t, r, "language", "v-Language")
	expectQuery(t, r, "movie_id", "7")
