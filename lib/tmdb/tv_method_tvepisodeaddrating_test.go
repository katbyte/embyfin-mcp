...
func TestOperationTvEpisodeAddRating(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.TvEpisodeAddRating(t.Context(), 7, 7, 7, TvEpisodeAddRatingRequest{}, TvEpisodeAddRatingOperationOptions{
