...
func TestOperationTvSeriesDeleteRating(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.TvSeriesDeleteRating(t.Context(), 7, TvSeriesDeleteRatingOperationOptions{
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodDelete, "/3/tv/7/rating")
