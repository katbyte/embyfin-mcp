...
func TestOperationTvSeriesAddRating(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.TvSeriesAddRating(t.Context(), 7, TvSeriesAddRatingRequest{}, TvSeriesAddRatingOperationOptions{
	...
	r, body := s.only(t)
	expectRequest(t, r, http.MethodPost, "/3/tv/7/rating")
