...
func TestOperationTvEpisodeDeleteRating(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.TvEpisodeDeleteRating(t.Context(), 7, 7, 7, TvEpisodeDeleteRatingOperationOptions{
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodDelete, "/3/tv/7/season/7/episode/7/rating")
