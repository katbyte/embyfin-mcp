...
func TestOperationFindById(t *testing.T) {
	...
	result, err := c.FindById(t.Context(), "p/externalId", FindByIdOperationOptions{
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/3/find/p%2FexternalId")
	expectQuery(t, r, "external_source", "v-ExternalSource")
