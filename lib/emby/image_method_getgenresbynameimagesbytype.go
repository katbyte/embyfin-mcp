...
// GetGenresByNameImagesByTypeOperationResponse is the result of GetGenresByNameImagesByType.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetGenresByNameImagesByTypeOperationResponse struct {
	HttpResponse *http.Response
}

// GetGenresByNameImagesByTypeOperationOptions holds the query and header parameters of GetGenresByNameImagesByType.
type GetGenresByNameImagesByTypeOperationOptions struct {
...
func (o GetGenresByNameImagesByTypeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetGenresByNameImagesByTypeOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetGenresByNameImagesByType(ctx context.Context, name string, typeParam ImageType, options GetGenresByNameImagesByTypeOperationOptions) (result GetGenresByNameImagesByTypeOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Genres/%s/Images/%s", url.PathEscape(name), url.PathEscape(string(typeParam))),
		StreamResponse: true,
	}
