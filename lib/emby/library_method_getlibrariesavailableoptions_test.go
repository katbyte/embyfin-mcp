...
func TestOperationGetLibrariesAvailableOptions(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetLibrariesAvailableOptions(t.Context(), GetLibrariesAvailableOptionsOperationOptions{
		LibraryContentType: "v-LibraryContentType",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Libraries/AvailableOptions")
	expectQuery(t, r, "LibraryContentType", "v-LibraryContentType")
	expectQuery(t, r, "IsNewLibrary", "true")
