...
// GetStudiosByNameImagesByTypeOperationResponse is the result of GetStudiosByNameImagesByType.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetStudiosByNameImagesByTypeOperationResponse struct {
	HttpResponse *http.Response
}

// GetStudiosByNameImagesByTypeOperationOptions holds the query and header parameters of GetStudiosByNameImagesByType.
type GetStudiosByNameImagesByTypeOperationOptions struct {
...
func (o GetStudiosByNameImagesByTypeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetStudiosByNameImagesByTypeOperationOptions) ToQuery() *client.QueryParams {
