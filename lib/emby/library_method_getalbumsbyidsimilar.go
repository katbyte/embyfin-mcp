...
// GetAlbumsByIdSimilarOperationResponse is the result of GetAlbumsByIdSimilar.
type GetAlbumsByIdSimilarOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetAlbumsByIdSimilarOperationOptions holds the query and header parameters of GetAlbumsByIdSimilar.
type GetAlbumsByIdSimilarOperationOptions struct {
...
func (o GetAlbumsByIdSimilarOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAlbumsByIdSimilarOperationOptions) ToQuery() *client.QueryParams {
...
// GetAlbumsByIdSimilar calls GET /Albums/{Id}/Similar. Finds albums similar to a given album.
func (c Client) GetAlbumsByIdSimilar(ctx context.Context, id string, options GetAlbumsByIdSimilarOperationOptions) (result GetAlbumsByIdSimilarOperationResponse, err error) {
...
// GetAlbumsByIdSimilarCompleteResult is every result GetAlbumsByIdSimilarComplete loaded.
type GetAlbumsByIdSimilarCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetAlbumsByIdSimilarComplete calls GetAlbumsByIdSimilar page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetAlbumsByIdSimilarComplete(ctx context.Context, id string, options GetAlbumsByIdSimilarOperationOptions) (result GetAlbumsByIdSimilarCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetAlbumsByIdSimilarOperationResponse
		page, err = c.GetAlbumsByIdSimilar(ctx, id, options)
