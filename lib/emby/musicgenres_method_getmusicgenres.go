...
// GetMusicGenresOperationResponse is the result of GetMusicGenres.
type GetMusicGenresOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetMusicGenresOperationOptions holds the query and header parameters of GetMusicGenres.
type GetMusicGenresOperationOptions struct {
...
func (o GetMusicGenresOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetMusicGenresOperationOptions) ToQuery() *client.QueryParams {
...
// GetMusicGenres calls GET /MusicGenres. Gets all music genres from a given item, folder, or the entire library.
func (c Client) GetMusicGenres(ctx context.Context, options GetMusicGenresOperationOptions) (result GetMusicGenresOperationResponse, err error) {
...
// GetMusicGenresCompleteResult is every result GetMusicGenresComplete loaded.
type GetMusicGenresCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetMusicGenresComplete calls GetMusicGenres page by page from options.StartIndex until every
...
func (c Client) GetMusicGenresComplete(ctx context.Context, options GetMusicGenresOperationOptions) (result GetMusicGenresCompleteResult, err error) {
	...
	for {
		...
		page, err = c.GetMusicGenres(ctx, options)
