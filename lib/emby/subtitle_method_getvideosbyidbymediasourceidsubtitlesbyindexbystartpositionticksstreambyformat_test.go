...
func TestOperationGetVideosByIdByMediaSourceIdSubtitlesByIndexByStartPositionTicksStreamByFormat(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "text/plain", "file bytes")
	result, err := c.GetVideosByIdByMediaSourceIdSubtitlesByIndexByStartPositionTicksStreamByFormat(t.Context(), "p/id", "p/mediaSourceId", 7, 7, "p/format", GetVideosByIdByMediaSourceIdSubtitlesByIndexByStartPositionTicksStreamByFormatOperationOptions{
