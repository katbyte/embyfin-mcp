...
// GetTrailersByIdSimilarOperationResponse is the result of GetTrailersByIdSimilar.
type GetTrailersByIdSimilarOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetTrailersByIdSimilarOperationOptions holds the query and header parameters of GetTrailersByIdSimilar.
type GetTrailersByIdSimilarOperationOptions struct {
...
func (o GetTrailersByIdSimilarOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetTrailersByIdSimilarOperationOptions) ToQuery() *client.QueryParams {
...
// GetTrailersByIdSimilar calls GET /Trailers/{Id}/Similar. Finds movies and trailers similar to a given trailer.
func (c Client) GetTrailersByIdSimilar(ctx context.Context, id string, options GetTrailersByIdSimilarOperationOptions) (result GetTrailersByIdSimilarOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Trailers/%s/Similar", url.PathEscape(id)),
	}
...
// GetTrailersByIdSimilarCompleteResult is every result GetTrailersByIdSimilarComplete loaded.
type GetTrailersByIdSimilarCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetTrailersByIdSimilarComplete calls GetTrailersByIdSimilar page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetTrailersByIdSimilarComplete(ctx context.Context, id string, options GetTrailersByIdSimilarOperationOptions) (result GetTrailersByIdSimilarCompleteResult, err error) {
	...
	for {
		var page GetTrailersByIdSimilarOperationResponse
		page, err = c.GetTrailersByIdSimilar(ctx, id, options)
