...
// GetUsersByUserIdSuggestionsOperationResponse is the result of GetUsersByUserIdSuggestions.
type GetUsersByUserIdSuggestionsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetUsersByUserIdSuggestionsOperationOptions holds the query and header parameters of GetUsersByUserIdSuggestions.
type GetUsersByUserIdSuggestionsOperationOptions struct {
...
func (o GetUsersByUserIdSuggestionsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetUsersByUserIdSuggestionsOperationOptions) ToQuery() *client.QueryParams {
...
// GetUsersByUserIdSuggestions calls GET /Users/{UserId}/Suggestions. Gets items based on a query.
func (c Client) GetUsersByUserIdSuggestions(ctx context.Context, userId string, options GetUsersByUserIdSuggestionsOperationOptions) (result GetUsersByUserIdSuggestionsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Users/%s/Suggestions", url.PathEscape(userId)),
	}
...
// GetUsersByUserIdSuggestionsCompleteResult is every result GetUsersByUserIdSuggestionsComplete loaded.
type GetUsersByUserIdSuggestionsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetUsersByUserIdSuggestionsComplete calls GetUsersByUserIdSuggestions page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetUsersByUserIdSuggestionsComplete(ctx context.Context, userId string, options GetUsersByUserIdSuggestionsOperationOptions) (result GetUsersByUserIdSuggestionsCompleteResult, err error) {
	...
	for {
		var page GetUsersByUserIdSuggestionsOperationResponse
		page, err = c.GetUsersByUserIdSuggestions(ctx, userId, options)
