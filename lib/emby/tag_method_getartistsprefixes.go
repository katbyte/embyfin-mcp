...
// GetArtistsPrefixesOperationResponse is the result of GetArtistsPrefixes.
type GetArtistsPrefixesOperationResponse struct {
	HttpResponse *http.Response
	Model        []NameValuePair
}

// GetArtistsPrefixesOperationOptions holds the query and header parameters of GetArtistsPrefixes.
type GetArtistsPrefixesOperationOptions struct {
...
func (o GetArtistsPrefixesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetArtistsPrefixesOperationOptions) ToQuery() *client.QueryParams {
...
// GetArtistsPrefixes calls GET /Artists/Prefixes. Gets items based on a query.
func (c Client) GetArtistsPrefixes(ctx context.Context, options GetArtistsPrefixesOperationOptions) (result GetArtistsPrefixesOperationResponse, err error) {
