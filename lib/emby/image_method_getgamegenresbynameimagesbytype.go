...
// GetGameGenresByNameImagesByTypeOperationResponse is the result of GetGameGenresByNameImagesByType.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetGameGenresByNameImagesByTypeOperationResponse struct {
	HttpResponse *http.Response
}

// GetGameGenresByNameImagesByTypeOperationOptions holds the query and header parameters of GetGameGenresByNameImagesByType.
type GetGameGenresByNameImagesByTypeOperationOptions struct {
...
func (o GetGameGenresByNameImagesByTypeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetGameGenresByNameImagesByTypeOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetGameGenresByNameImagesByType(ctx context.Context, name string, typeParam ImageType, options GetGameGenresByNameImagesByTypeOperationOptions) (result GetGameGenresByNameImagesByTypeOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/GameGenres/%s/Images/%s", url.PathEscape(name), url.PathEscape(string(typeParam))),
		StreamResponse: true,
	}
