...
// GetShowsByIdSimilarOperationResponse is the result of GetShowsByIdSimilar.
type GetShowsByIdSimilarOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetShowsByIdSimilarOperationOptions holds the query and header parameters of GetShowsByIdSimilar.
type GetShowsByIdSimilarOperationOptions struct {
...
func (o GetShowsByIdSimilarOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetShowsByIdSimilarOperationOptions) ToQuery() *client.QueryParams {
...
// GetShowsByIdSimilar calls GET /Shows/{Id}/Similar. Finds tv shows similar to a given one.
func (c Client) GetShowsByIdSimilar(ctx context.Context, id string, options GetShowsByIdSimilarOperationOptions) (result GetShowsByIdSimilarOperationResponse, err error) {
...
// GetShowsByIdSimilarCompleteResult is every result GetShowsByIdSimilarComplete loaded.
type GetShowsByIdSimilarCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetShowsByIdSimilarComplete calls GetShowsByIdSimilar page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetShowsByIdSimilarComplete(ctx context.Context, id string, options GetShowsByIdSimilarOperationOptions) (result GetShowsByIdSimilarCompleteResult, err error) {
	...
	for {
		var page GetShowsByIdSimilarOperationResponse
		page, err = c.GetShowsByIdSimilar(ctx, id, options)
