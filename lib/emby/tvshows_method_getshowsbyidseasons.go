...
// GetShowsByIdSeasonsOperationResponse is the result of GetShowsByIdSeasons.
type GetShowsByIdSeasonsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetShowsByIdSeasonsOperationOptions holds the query and header parameters of GetShowsByIdSeasons.
type GetShowsByIdSeasonsOperationOptions struct {
...
func (o GetShowsByIdSeasonsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetShowsByIdSeasonsOperationOptions) ToQuery() *client.QueryParams {
...
// GetShowsByIdSeasons calls GET /Shows/{Id}/Seasons. Gets seasons for a tv series.
func (c Client) GetShowsByIdSeasons(ctx context.Context, id string, options GetShowsByIdSeasonsOperationOptions) (result GetShowsByIdSeasonsOperationResponse, err error) {
...
// GetShowsByIdSeasonsCompleteResult is every result GetShowsByIdSeasonsComplete loaded.
type GetShowsByIdSeasonsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetShowsByIdSeasonsComplete calls GetShowsByIdSeasons page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetShowsByIdSeasonsComplete(ctx context.Context, id string, options GetShowsByIdSeasonsOperationOptions) (result GetShowsByIdSeasonsCompleteResult, err error) {
	...
	for {
		var page GetShowsByIdSeasonsOperationResponse
		page, err = c.GetShowsByIdSeasons(ctx, id, options)
