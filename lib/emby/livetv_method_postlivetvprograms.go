...
// PostLiveTvProgramsOperationResponse is the result of PostLiveTvPrograms.
type PostLiveTvProgramsOperationResponse struct {
	HttpResponse *http.Response
}

// PostLiveTvProgramsOperationOptions holds the query and header parameters of PostLiveTvPrograms.
type PostLiveTvProgramsOperationOptions struct {
...
func (o PostLiveTvProgramsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o PostLiveTvProgramsOperationOptions) ToQuery() *client.QueryParams {
...
// PostLiveTvPrograms calls POST /LiveTv/Programs. Gets available live tv epgs..
func (c Client) PostLiveTvPrograms(ctx context.Context, input ApiBaseItemsRequest, options PostLiveTvProgramsOperationOptions) (result PostLiveTvProgramsOperationResponse, err error) {
