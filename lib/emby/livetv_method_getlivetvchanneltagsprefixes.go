...
// GetLiveTvChannelTagsPrefixesOperationResponse is the result of GetLiveTvChannelTagsPrefixes.
type GetLiveTvChannelTagsPrefixesOperationResponse struct {
	HttpResponse *http.Response
	Model        []ApiTagItem
}

// GetLiveTvChannelTagsPrefixesOperationOptions holds the query and header parameters of GetLiveTvChannelTagsPrefixes.
type GetLiveTvChannelTagsPrefixesOperationOptions struct {
...
func (o GetLiveTvChannelTagsPrefixesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetLiveTvChannelTagsPrefixesOperationOptions) ToQuery() *client.QueryParams {
...
// GetLiveTvChannelTagsPrefixes calls GET /LiveTv/ChannelTags/Prefixes. Gets live tv channel tag prefixes.
func (c Client) GetLiveTvChannelTagsPrefixes(ctx context.Context, options GetLiveTvChannelTagsPrefixesOperationOptions) (result GetLiveTvChannelTagsPrefixesOperationResponse, err error) {
