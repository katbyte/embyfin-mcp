...
// GetItemTypesOperationResponse is the result of GetItemTypes.
type GetItemTypesOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetItemTypesOperationOptions holds the query and header parameters of GetItemTypes.
type GetItemTypesOperationOptions struct {
...
func (o GetItemTypesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemTypesOperationOptions) ToQuery() *client.QueryParams {
...
// GetItemTypes calls GET /ItemTypes. Gets items based on a query.
func (c Client) GetItemTypes(ctx context.Context, options GetItemTypesOperationOptions) (result GetItemTypesOperationResponse, err error) {
...
// GetItemTypesCompleteResult is every result GetItemTypesComplete loaded.
type GetItemTypesCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetItemTypesComplete calls GetItemTypes page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetItemTypesComplete(ctx context.Context, options GetItemTypesOperationOptions) (result GetItemTypesCompleteResult, err error) {
	...
	for {
		var page GetItemTypesOperationResponse
		page, err = c.GetItemTypes(ctx, options)
