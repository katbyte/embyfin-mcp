...
// GetPlaylistsByIdInstantMixOperationResponse is the result of GetPlaylistsByIdInstantMix.
type GetPlaylistsByIdInstantMixOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetPlaylistsByIdInstantMixOperationOptions holds the query and header parameters of GetPlaylistsByIdInstantMix.
type GetPlaylistsByIdInstantMixOperationOptions struct {
...
func (o GetPlaylistsByIdInstantMixOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetPlaylistsByIdInstantMixOperationOptions) ToQuery() *client.QueryParams {
...
// GetPlaylistsByIdInstantMix calls GET /Playlists/{Id}/InstantMix. Creates an instant playlist based on a given playlist.
func (c Client) GetPlaylistsByIdInstantMix(ctx context.Context, id string, options GetPlaylistsByIdInstantMixOperationOptions) (result GetPlaylistsByIdInstantMixOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Playlists/%s/InstantMix", url.PathEscape(id)),
	}
...
// GetPlaylistsByIdInstantMixCompleteResult is every result GetPlaylistsByIdInstantMixComplete loaded.
type GetPlaylistsByIdInstantMixCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetPlaylistsByIdInstantMixComplete calls GetPlaylistsByIdInstantMix page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetPlaylistsByIdInstantMixComplete(ctx context.Context, id string, options GetPlaylistsByIdInstantMixOperationOptions) (result GetPlaylistsByIdInstantMixCompleteResult, err error) {
	...
	for {
		var page GetPlaylistsByIdInstantMixOperationResponse
		page, err = c.GetPlaylistsByIdInstantMix(ctx, id, options)
