...
// GetMusicGenresByNameImagesByTypeOperationResponse is the result of GetMusicGenresByNameImagesByType.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetMusicGenresByNameImagesByTypeOperationResponse struct {
	HttpResponse *http.Response
}

// GetMusicGenresByNameImagesByTypeOperationOptions holds the query and header parameters of GetMusicGenresByNameImagesByType.
type GetMusicGenresByNameImagesByTypeOperationOptions struct {
...
func (o GetMusicGenresByNameImagesByTypeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetMusicGenresByNameImagesByTypeOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetMusicGenresByNameImagesByType(ctx context.Context, name string, typeParam ImageType, options GetMusicGenresByNameImagesByTypeOperationOptions) (result GetMusicGenresByNameImagesByTypeOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/MusicGenres/%s/Images/%s", url.PathEscape(name), url.PathEscape(string(typeParam))),
		StreamResponse: true,
	}
