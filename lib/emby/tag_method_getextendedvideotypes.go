...
// GetExtendedVideoTypesOperationResponse is the result of GetExtendedVideoTypes.
type GetExtendedVideoTypesOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetExtendedVideoTypesOperationOptions holds the query and header parameters of GetExtendedVideoTypes.
type GetExtendedVideoTypesOperationOptions struct {
...
func (o GetExtendedVideoTypesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetExtendedVideoTypesOperationOptions) ToQuery() *client.QueryParams {
...
// GetExtendedVideoTypes calls GET /ExtendedVideoTypes. Gets items based on a query.
func (c Client) GetExtendedVideoTypes(ctx context.Context, options GetExtendedVideoTypesOperationOptions) (result GetExtendedVideoTypesOperationResponse, err error) {
	...
	var model QueryResultUserLibraryTagItem
	result.Model = &model
...
// GetExtendedVideoTypesCompleteResult is every result GetExtendedVideoTypesComplete loaded.
type GetExtendedVideoTypesCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetExtendedVideoTypesComplete calls GetExtendedVideoTypes page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetExtendedVideoTypesComplete(ctx context.Context, options GetExtendedVideoTypesOperationOptions) (result GetExtendedVideoTypesCompleteResult, err error) {
	...
	for {
		var page GetExtendedVideoTypesOperationResponse
		page, err = c.GetExtendedVideoTypes(ctx, options)
