...
// GetAudioByIdByStreamFileNameOperationResponse is the result of GetAudioByIdByStreamFileName.
//
// The operation answers audio/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetAudioByIdByStreamFileNameOperationResponse struct {
	HttpResponse *http.Response
}

// GetAudioByIdByStreamFileNameOperationOptions holds the query and header parameters of GetAudioByIdByStreamFileName.
type GetAudioByIdByStreamFileNameOperationOptions struct {
...
func (o GetAudioByIdByStreamFileNameOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAudioByIdByStreamFileNameOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetAudioByIdByStreamFileName(ctx context.Context, id string, streamFileName string, options GetAudioByIdByStreamFileNameOperationOptions) (result GetAudioByIdByStreamFileNameOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Audio/%s/%s", url.PathEscape(id), url.PathEscape(streamFileName)),
		StreamResponse: true,
	}
