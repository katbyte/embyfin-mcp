...
// GetAudioCodecsOperationResponse is the result of GetAudioCodecs.
type GetAudioCodecsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetAudioCodecsOperationOptions holds the query and header parameters of GetAudioCodecs.
type GetAudioCodecsOperationOptions struct {
...
func (o GetAudioCodecsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAudioCodecsOperationOptions) ToQuery() *client.QueryParams {
...
// GetAudioCodecs calls GET /AudioCodecs. Gets items based on a query.
func (c Client) GetAudioCodecs(ctx context.Context, options GetAudioCodecsOperationOptions) (result GetAudioCodecsOperationResponse, err error) {
...
// GetAudioCodecsCompleteResult is every result GetAudioCodecsComplete loaded.
type GetAudioCodecsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetAudioCodecsComplete calls GetAudioCodecs page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetAudioCodecsComplete(ctx context.Context, options GetAudioCodecsOperationOptions) (result GetAudioCodecsCompleteResult, err error) {
	...
	for {
		var page GetAudioCodecsOperationResponse
		page, err = c.GetAudioCodecs(ctx, options)
