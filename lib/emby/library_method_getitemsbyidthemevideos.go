...
// GetItemsByIdThemeVideosOperationResponse is the result of GetItemsByIdThemeVideos.
type GetItemsByIdThemeVideosOperationResponse struct {
	HttpResponse *http.Response
	Model        *ThemeMediaResult
}

// GetItemsByIdThemeVideosOperationOptions holds the query and header parameters of GetItemsByIdThemeVideos.
type GetItemsByIdThemeVideosOperationOptions struct {
...
func (o GetItemsByIdThemeVideosOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemsByIdThemeVideosOperationOptions) ToQuery() *client.QueryParams {
...
// GetItemsByIdThemeVideos calls GET /Items/{Id}/ThemeVideos. Gets theme videos for an item.
func (c Client) GetItemsByIdThemeVideos(ctx context.Context, id string, options GetItemsByIdThemeVideosOperationOptions) (result GetItemsByIdThemeVideosOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Items/%s/ThemeVideos", url.PathEscape(id)),
	}
...
// GetItemsByIdThemeVideosCompleteResult is every result GetItemsByIdThemeVideosComplete loaded.
type GetItemsByIdThemeVideosCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetItemsByIdThemeVideosComplete calls GetItemsByIdThemeVideos page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetItemsByIdThemeVideosComplete(ctx context.Context, id string, options GetItemsByIdThemeVideosOperationOptions) (result GetItemsByIdThemeVideosCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetItemsByIdThemeVideosOperationResponse
		page, err = c.GetItemsByIdThemeVideos(ctx, id, options)
