...
// GetAudioByIdMasterM3u8OperationResponse is the result of GetAudioByIdMasterM3u8.
//
// The operation answers application/x-mpegURL, left unread in HttpResponse.Body, which
// the caller must close.
type GetAudioByIdMasterM3u8OperationResponse struct {
	HttpResponse *http.Response
}

// GetAudioByIdMasterM3u8OperationOptions holds the query and header parameters of GetAudioByIdMasterM3u8.
type GetAudioByIdMasterM3u8OperationOptions struct {
...
func (o GetAudioByIdMasterM3u8OperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAudioByIdMasterM3u8OperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetAudioByIdMasterM3u8(ctx context.Context, id string, options GetAudioByIdMasterM3u8OperationOptions) (result GetAudioByIdMasterM3u8OperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Audio/%s/master.m3u8", url.PathEscape(id)),
		StreamResponse: true,
	}
