...
// GetSubtitleCodecsOperationResponse is the result of GetSubtitleCodecs.
type GetSubtitleCodecsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetSubtitleCodecsOperationOptions holds the query and header parameters of GetSubtitleCodecs.
type GetSubtitleCodecsOperationOptions struct {
...
func (o GetSubtitleCodecsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetSubtitleCodecsOperationOptions) ToQuery() *client.QueryParams {
...
// GetSubtitleCodecs calls GET /SubtitleCodecs. Gets items based on a query.
func (c Client) GetSubtitleCodecs(ctx context.Context, options GetSubtitleCodecsOperationOptions) (result GetSubtitleCodecsOperationResponse, err error) {
...
// GetSubtitleCodecsCompleteResult is every result GetSubtitleCodecsComplete loaded.
type GetSubtitleCodecsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetSubtitleCodecsComplete calls GetSubtitleCodecs page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetSubtitleCodecsComplete(ctx context.Context, options GetSubtitleCodecsOperationOptions) (result GetSubtitleCodecsCompleteResult, err error) {
	...
	for {
		var page GetSubtitleCodecsOperationResponse
		page, err = c.GetSubtitleCodecs(ctx, options)
