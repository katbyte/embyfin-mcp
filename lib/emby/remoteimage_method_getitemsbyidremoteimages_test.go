...
func TestOperationGetItemsByIdRemoteImages(t *testing.T) {
	t.Parallel()
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Items/p%2Fid/RemoteImages")
	...
	expectQuery(t, r, "EnableSeriesImages", "true")
