...
// GetUsersByUserIdItemsOperationResponse is the result of GetUsersByUserIdItems.
type GetUsersByUserIdItemsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetUsersByUserIdItemsOperationOptions holds the query and header parameters of GetUsersByUserIdItems.
type GetUsersByUserIdItemsOperationOptions struct {
...
func (o GetUsersByUserIdItemsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetUsersByUserIdItemsOperationOptions) ToQuery() *client.QueryParams {
...
// GetUsersByUserIdItems calls GET /Users/{UserId}/Items. Gets items based on a query.
func (c Client) GetUsersByUserIdItems(ctx context.Context, userId string, options GetUsersByUserIdItemsOperationOptions) (result GetUsersByUserIdItemsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Users/%s/Items", url.PathEscape(userId)),
	}
...
// GetUsersByUserIdItemsCompleteResult is every result GetUsersByUserIdItemsComplete loaded.
type GetUsersByUserIdItemsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetUsersByUserIdItemsComplete calls GetUsersByUserIdItems page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetUsersByUserIdItemsComplete(ctx context.Context, userId string, options GetUsersByUserIdItemsOperationOptions) (result GetUsersByUserIdItemsCompleteResult, err error) {
	...
	for {
		var page GetUsersByUserIdItemsOperationResponse
		page, err = c.GetUsersByUserIdItems(ctx, userId, options)
