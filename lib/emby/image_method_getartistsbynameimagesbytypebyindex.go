...
// GetArtistsByNameImagesByTypeByIndexOperationResponse is the result of GetArtistsByNameImagesByTypeByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetArtistsByNameImagesByTypeByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetArtistsByNameImagesByTypeByIndexOperationOptions holds the query and header parameters of GetArtistsByNameImagesByTypeByIndex.
type GetArtistsByNameImagesByTypeByIndexOperationOptions struct {
...
func (o GetArtistsByNameImagesByTypeByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetArtistsByNameImagesByTypeByIndexOperationOptions) ToQuery() *client.QueryParams {
