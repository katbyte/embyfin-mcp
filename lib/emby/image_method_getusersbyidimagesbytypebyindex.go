...
// GetUsersByIdImagesByTypeByIndexOperationResponse is the result of GetUsersByIdImagesByTypeByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetUsersByIdImagesByTypeByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetUsersByIdImagesByTypeByIndexOperationOptions holds the query and header parameters of GetUsersByIdImagesByTypeByIndex.
type GetUsersByIdImagesByTypeByIndexOperationOptions struct {
...
func (o GetUsersByIdImagesByTypeByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetUsersByIdImagesByTypeByIndexOperationOptions) ToQuery() *client.QueryParams {
