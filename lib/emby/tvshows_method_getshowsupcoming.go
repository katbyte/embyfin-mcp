...
// GetShowsUpcomingOperationResponse is the result of GetShowsUpcoming.
type GetShowsUpcomingOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetShowsUpcomingOperationOptions holds the query and header parameters of GetShowsUpcoming.
type GetShowsUpcomingOperationOptions struct {
...
func (o GetShowsUpcomingOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetShowsUpcomingOperationOptions) ToQuery() *client.QueryParams {
...
// GetShowsUpcoming calls GET /Shows/Upcoming. Gets a list of upcoming episodes.
func (c Client) GetShowsUpcoming(ctx context.Context, options GetShowsUpcomingOperationOptions) (result GetShowsUpcomingOperationResponse, err error) {
...
// GetShowsUpcomingCompleteResult is every result GetShowsUpcomingComplete loaded.
type GetShowsUpcomingCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetShowsUpcomingComplete calls GetShowsUpcoming page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetShowsUpcomingComplete(ctx context.Context, options GetShowsUpcomingOperationOptions) (result GetShowsUpcomingCompleteResult, err error) {
	...
	for {
		var page GetShowsUpcomingOperationResponse
		page, err = c.GetShowsUpcoming(ctx, options)
