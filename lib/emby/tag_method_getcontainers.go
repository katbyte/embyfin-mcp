...
// GetContainersOperationResponse is the result of GetContainers.
type GetContainersOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetContainersOperationOptions holds the query and header parameters of GetContainers.
type GetContainersOperationOptions struct {
...
func (o GetContainersOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetContainersOperationOptions) ToQuery() *client.QueryParams {
...
// GetContainers calls GET /Containers. Gets items based on a query.
func (c Client) GetContainers(ctx context.Context, options GetContainersOperationOptions) (result GetContainersOperationResponse, err error) {
...
// GetContainersCompleteResult is every result GetContainersComplete loaded.
type GetContainersCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetContainersComplete calls GetContainers page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetContainersComplete(ctx context.Context, options GetContainersOperationOptions) (result GetContainersCompleteResult, err error) {
	...
	for {
		var page GetContainersOperationResponse
		page, err = c.GetContainers(ctx, options)
