...
func TestOperationGetLiveTvTimersDefaults(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetLiveTvTimersDefaults(t.Context(), GetLiveTvTimersDefaultsOperationOptions{
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/LiveTv/Timers/Defaults")
	expectQuery(t, r, "ProgramId", "v-ProgramId")
