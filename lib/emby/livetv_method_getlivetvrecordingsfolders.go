...
// GetLiveTvRecordingsFoldersOperationResponse is the result of GetLiveTvRecordingsFolders.
type GetLiveTvRecordingsFoldersOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetLiveTvRecordingsFoldersOperationOptions holds the query and header parameters of GetLiveTvRecordingsFolders.
type GetLiveTvRecordingsFoldersOperationOptions struct {
...
func (o GetLiveTvRecordingsFoldersOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetLiveTvRecordingsFoldersOperationOptions) ToQuery() *client.QueryParams {
...
// GetLiveTvRecordingsFolders calls GET /LiveTv/Recordings/Folders. Gets recording folders.
func (c Client) GetLiveTvRecordingsFolders(ctx context.Context, options GetLiveTvRecordingsFoldersOperationOptions) (result GetLiveTvRecordingsFoldersOperationResponse, err error) {
...
// GetLiveTvRecordingsFoldersCompleteResult is every result GetLiveTvRecordingsFoldersComplete loaded.
type GetLiveTvRecordingsFoldersCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetLiveTvRecordingsFoldersComplete calls GetLiveTvRecordingsFolders page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetLiveTvRecordingsFoldersComplete(ctx context.Context, options GetLiveTvRecordingsFoldersOperationOptions) (result GetLiveTvRecordingsFoldersCompleteResult, err error) {
	...
	for {
		var page GetLiveTvRecordingsFoldersOperationResponse
		page, err = c.GetLiveTvRecordingsFolders(ctx, options)
