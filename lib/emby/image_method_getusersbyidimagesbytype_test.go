...
func TestOperationGetUsersByIdImagesByType(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "image/png", "file bytes")
	result, err := c.GetUsersByIdImagesByType(t.Context(), "p/id", ImageTypePrimary, GetUsersByIdImagesByTypeOperationOptions{
		MaxWidth:             7,
		MaxHeight:            7,
		Width:                7,
		Height:               7,
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Users/p%2Fid/Images/Primary")
