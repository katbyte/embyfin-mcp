...
// GetItemsByIdImagesByTypeOperationResponse is the result of GetItemsByIdImagesByType.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetItemsByIdImagesByTypeOperationResponse struct {
	HttpResponse *http.Response
}

// GetItemsByIdImagesByTypeOperationOptions holds the query and header parameters of GetItemsByIdImagesByType.
type GetItemsByIdImagesByTypeOperationOptions struct {
...
func (o GetItemsByIdImagesByTypeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemsByIdImagesByTypeOperationOptions) ToQuery() *client.QueryParams {
