...
// GetUsersByUserIdSectionsBySectionIdItemsOperationResponse is the result of GetUsersByUserIdSectionsBySectionIdItems.
type GetUsersByUserIdSectionsBySectionIdItemsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetUsersByUserIdSectionsBySectionIdItemsOperationOptions holds the query and header parameters of GetUsersByUserIdSectionsBySectionIdItems.
type GetUsersByUserIdSectionsBySectionIdItemsOperationOptions struct {
...
func (o GetUsersByUserIdSectionsBySectionIdItemsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetUsersByUserIdSectionsBySectionIdItemsOperationOptions) ToQuery() *client.QueryParams {
...
// GetUsersByUserIdSectionsBySectionIdItems calls GET /Users/{UserId}/Sections/{SectionId}/Items. Requires authentication as user.
func (c Client) GetUsersByUserIdSectionsBySectionIdItems(ctx context.Context, userId string, sectionId string, options GetUsersByUserIdSectionsBySectionIdItemsOperationOptions) (result GetUsersByUserIdSectionsBySectionIdItemsOperationResponse, err error) {
...
// GetUsersByUserIdSectionsBySectionIdItemsCompleteResult is every result GetUsersByUserIdSectionsBySectionIdItemsComplete loaded.
type GetUsersByUserIdSectionsBySectionIdItemsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetUsersByUserIdSectionsBySectionIdItemsComplete calls GetUsersByUserIdSectionsBySectionIdItems page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetUsersByUserIdSectionsBySectionIdItemsComplete(ctx context.Context, userId string, sectionId string, options GetUsersByUserIdSectionsBySectionIdItemsOperationOptions) (result GetUsersByUserIdSectionsBySectionIdItemsCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetUsersByUserIdSectionsBySectionIdItemsOperationResponse
		page, err = c.GetUsersByUserIdSectionsBySectionIdItems(ctx, userId, sectionId, options)
