...
func TestOperationPostLiveTvChannelMappings(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "", "")
	result, err := c.PostLiveTvChannelMappings(t.Context(), ApiSetChannelMapping{}, PostLiveTvChannelMappingsOperationOptions{
