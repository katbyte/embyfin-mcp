...
// GetMoviesByIdSimilarOperationResponse is the result of GetMoviesByIdSimilar.
type GetMoviesByIdSimilarOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetMoviesByIdSimilarOperationOptions holds the query and header parameters of GetMoviesByIdSimilar.
type GetMoviesByIdSimilarOperationOptions struct {
...
func (o GetMoviesByIdSimilarOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetMoviesByIdSimilarOperationOptions) ToQuery() *client.QueryParams {
...
// GetMoviesByIdSimilar calls GET /Movies/{Id}/Similar. Finds movies and trailers similar to a given movie.
func (c Client) GetMoviesByIdSimilar(ctx context.Context, id string, options GetMoviesByIdSimilarOperationOptions) (result GetMoviesByIdSimilarOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Movies/%s/Similar", url.PathEscape(id)),
	}
...
// GetMoviesByIdSimilarCompleteResult is every result GetMoviesByIdSimilarComplete loaded.
type GetMoviesByIdSimilarCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetMoviesByIdSimilarComplete calls GetMoviesByIdSimilar page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetMoviesByIdSimilarComplete(ctx context.Context, id string, options GetMoviesByIdSimilarOperationOptions) (result GetMoviesByIdSimilarCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetMoviesByIdSimilarOperationResponse
		page, err = c.GetMoviesByIdSimilar(ctx, id, options)
