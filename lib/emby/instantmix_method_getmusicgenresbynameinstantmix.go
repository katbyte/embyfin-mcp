...
// GetMusicGenresByNameInstantMixOperationResponse is the result of GetMusicGenresByNameInstantMix.
type GetMusicGenresByNameInstantMixOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetMusicGenresByNameInstantMixOperationOptions holds the query and header parameters of GetMusicGenresByNameInstantMix.
type GetMusicGenresByNameInstantMixOperationOptions struct {
...
func (o GetMusicGenresByNameInstantMixOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetMusicGenresByNameInstantMixOperationOptions) ToQuery() *client.QueryParams {
...
// GetMusicGenresByNameInstantMix calls GET /MusicGenres/{Name}/InstantMix. Creates an instant playlist based on a music genre.
func (c Client) GetMusicGenresByNameInstantMix(ctx context.Context, name string, options GetMusicGenresByNameInstantMixOperationOptions) (result GetMusicGenresByNameInstantMixOperationResponse, err error) {
...
// GetMusicGenresByNameInstantMixCompleteResult is every result GetMusicGenresByNameInstantMixComplete loaded.
type GetMusicGenresByNameInstantMixCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetMusicGenresByNameInstantMixComplete calls GetMusicGenresByNameInstantMix page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetMusicGenresByNameInstantMixComplete(ctx context.Context, name string, options GetMusicGenresByNameInstantMixOperationOptions) (result GetMusicGenresByNameInstantMixCompleteResult, err error) {
	...
	for {
		var page GetMusicGenresByNameInstantMixOperationResponse
		page, err = c.GetMusicGenresByNameInstantMix(ctx, name, options)
