...
func TestOperationGetUsersByUserIdItemsByIdIntros(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetUsersByUserIdItemsByIdIntros(t.Context(), "p/userId", "p/id", GetUsersByUserIdItemsByIdIntrosOperationOptions{
		Fields:           "v-Fields",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Users/p%2FuserId/Items/p%2Fid/Intros")
