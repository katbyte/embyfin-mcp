...
// GetPersonsByNameImagesByTypeOperationResponse is the result of GetPersonsByNameImagesByType.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetPersonsByNameImagesByTypeOperationResponse struct {
	HttpResponse *http.Response
}

// GetPersonsByNameImagesByTypeOperationOptions holds the query and header parameters of GetPersonsByNameImagesByType.
type GetPersonsByNameImagesByTypeOperationOptions struct {
...
func (o GetPersonsByNameImagesByTypeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetPersonsByNameImagesByTypeOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetPersonsByNameImagesByType(ctx context.Context, name string, typeParam ImageType, options GetPersonsByNameImagesByTypeOperationOptions) (result GetPersonsByNameImagesByTypeOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Persons/%s/Images/%s", url.PathEscape(name), url.PathEscape(string(typeParam))),
		StreamResponse: true,
	}
