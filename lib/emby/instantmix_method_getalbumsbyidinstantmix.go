...
// GetAlbumsByIdInstantMixOperationResponse is the result of GetAlbumsByIdInstantMix.
type GetAlbumsByIdInstantMixOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetAlbumsByIdInstantMixOperationOptions holds the query and header parameters of GetAlbumsByIdInstantMix.
type GetAlbumsByIdInstantMixOperationOptions struct {
...
func (o GetAlbumsByIdInstantMixOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAlbumsByIdInstantMixOperationOptions) ToQuery() *client.QueryParams {
...
// GetAlbumsByIdInstantMix calls GET /Albums/{Id}/InstantMix. Creates an instant playlist based on a given album.
func (c Client) GetAlbumsByIdInstantMix(ctx context.Context, id string, options GetAlbumsByIdInstantMixOperationOptions) (result GetAlbumsByIdInstantMixOperationResponse, err error) {
...
// GetAlbumsByIdInstantMixCompleteResult is every result GetAlbumsByIdInstantMixComplete loaded.
type GetAlbumsByIdInstantMixCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetAlbumsByIdInstantMixComplete calls GetAlbumsByIdInstantMix page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetAlbumsByIdInstantMixComplete(ctx context.Context, id string, options GetAlbumsByIdInstantMixOperationOptions) (result GetAlbumsByIdInstantMixCompleteResult, err error) {
	...
	for {
		var page GetAlbumsByIdInstantMixOperationResponse
		page, err = c.GetAlbumsByIdInstantMix(ctx, id, options)
