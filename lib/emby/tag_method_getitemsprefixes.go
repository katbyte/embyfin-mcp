...
// GetItemsPrefixesOperationResponse is the result of GetItemsPrefixes.
type GetItemsPrefixesOperationResponse struct {
	HttpResponse *http.Response
	Model        []NameValuePair
}

// GetItemsPrefixesOperationOptions holds the query and header parameters of GetItemsPrefixes.
type GetItemsPrefixesOperationOptions struct {
...
func (o GetItemsPrefixesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemsPrefixesOperationOptions) ToQuery() *client.QueryParams {
...
// GetItemsPrefixes calls GET /Items/Prefixes. Gets items based on a query.
func (c Client) GetItemsPrefixes(ctx context.Context, options GetItemsPrefixesOperationOptions) (result GetItemsPrefixesOperationResponse, err error) {
