...
// GetOfficialRatingsOperationResponse is the result of GetOfficialRatings.
type GetOfficialRatingsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryOfficialRatingItem
}

// GetOfficialRatingsOperationOptions holds the query and header parameters of GetOfficialRatings.
type GetOfficialRatingsOperationOptions struct {
...
func (o GetOfficialRatingsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetOfficialRatingsOperationOptions) ToQuery() *client.QueryParams {
...
// GetOfficialRatings calls GET /OfficialRatings. Gets items based on a query.
func (c Client) GetOfficialRatings(ctx context.Context, options GetOfficialRatingsOperationOptions) (result GetOfficialRatingsOperationResponse, err error) {
	...
	var model QueryResultUserLibraryOfficialRatingItem
	result.Model = &model
...
// GetOfficialRatingsCompleteResult is every result GetOfficialRatingsComplete loaded.
type GetOfficialRatingsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryOfficialRatingItem
}

// GetOfficialRatingsComplete calls GetOfficialRatings page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetOfficialRatingsComplete(ctx context.Context, options GetOfficialRatingsOperationOptions) (result GetOfficialRatingsCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetOfficialRatingsOperationResponse
		page, err = c.GetOfficialRatings(ctx, options)
