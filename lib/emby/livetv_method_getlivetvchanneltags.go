...
// GetLiveTvChannelTagsOperationResponse is the result of GetLiveTvChannelTags.
type GetLiveTvChannelTagsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetLiveTvChannelTagsOperationOptions holds the query and header parameters of GetLiveTvChannelTags.
type GetLiveTvChannelTagsOperationOptions struct {
...
func (o GetLiveTvChannelTagsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetLiveTvChannelTagsOperationOptions) ToQuery() *client.QueryParams {
...
// GetLiveTvChannelTags calls GET /LiveTv/ChannelTags. Gets live tv channel tags.
func (c Client) GetLiveTvChannelTags(ctx context.Context, options GetLiveTvChannelTagsOperationOptions) (result GetLiveTvChannelTagsOperationResponse, err error) {
...
// GetLiveTvChannelTagsCompleteResult is every result GetLiveTvChannelTagsComplete loaded.
type GetLiveTvChannelTagsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetLiveTvChannelTagsComplete calls GetLiveTvChannelTags page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetLiveTvChannelTagsComplete(ctx context.Context, options GetLiveTvChannelTagsOperationOptions) (result GetLiveTvChannelTagsCompleteResult, err error) {
	...
	for {
		var page GetLiveTvChannelTagsOperationResponse
		page, err = c.GetLiveTvChannelTags(ctx, options)
