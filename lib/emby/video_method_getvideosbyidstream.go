...
// GetVideosByIdStreamOperationResponse is the result of GetVideosByIdStream.
//
// The operation answers video/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetVideosByIdStreamOperationResponse struct {
	HttpResponse *http.Response
}

// GetVideosByIdStreamOperationOptions holds the query and header parameters of GetVideosByIdStream.
type GetVideosByIdStreamOperationOptions struct {
...
func (o GetVideosByIdStreamOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetVideosByIdStreamOperationOptions) ToQuery() *client.QueryParams {
