...
// GetItemsByIdSimilarOperationResponse is the result of GetItemsByIdSimilar.
type GetItemsByIdSimilarOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetItemsByIdSimilarOperationOptions holds the query and header parameters of GetItemsByIdSimilar.
type GetItemsByIdSimilarOperationOptions struct {
...
func (o GetItemsByIdSimilarOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemsByIdSimilarOperationOptions) ToQuery() *client.QueryParams {
...
// GetItemsByIdSimilar calls GET /Items/{Id}/Similar. Gets similar items.
func (c Client) GetItemsByIdSimilar(ctx context.Context, id string, options GetItemsByIdSimilarOperationOptions) (result GetItemsByIdSimilarOperationResponse, err error) {
...
// GetItemsByIdSimilarCompleteResult is every result GetItemsByIdSimilarComplete loaded.
type GetItemsByIdSimilarCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetItemsByIdSimilarComplete calls GetItemsByIdSimilar page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetItemsByIdSimilarComplete(ctx context.Context, id string, options GetItemsByIdSimilarOperationOptions) (result GetItemsByIdSimilarCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetItemsByIdSimilarOperationResponse
		page, err = c.GetItemsByIdSimilar(ctx, id, options)
