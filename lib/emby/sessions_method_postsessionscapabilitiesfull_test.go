...
func TestOperationPostSessionsCapabilitiesFull(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "", "")
	result, err := c.PostSessionsCapabilitiesFull(t.Context(), ClientCapabilities{}, PostSessionsCapabilitiesFullOperationOptions{
		Id: "v-Id",
	})
	if err != nil {
		t.Fatal(err)
