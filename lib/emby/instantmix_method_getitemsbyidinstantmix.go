...
// GetItemsByIdInstantMixOperationResponse is the result of GetItemsByIdInstantMix.
type GetItemsByIdInstantMixOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetItemsByIdInstantMixOperationOptions holds the query and header parameters of GetItemsByIdInstantMix.
type GetItemsByIdInstantMixOperationOptions struct {
...
func (o GetItemsByIdInstantMixOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemsByIdInstantMixOperationOptions) ToQuery() *client.QueryParams {
...
// GetItemsByIdInstantMix calls GET /Items/{Id}/InstantMix. Creates an instant playlist based on a given item.
func (c Client) GetItemsByIdInstantMix(ctx context.Context, id string, options GetItemsByIdInstantMixOperationOptions) (result GetItemsByIdInstantMixOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Items/%s/InstantMix", url.PathEscape(id)),
	}
...
// GetItemsByIdInstantMixCompleteResult is every result GetItemsByIdInstantMixComplete loaded.
type GetItemsByIdInstantMixCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetItemsByIdInstantMixComplete calls GetItemsByIdInstantMix page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetItemsByIdInstantMixComplete(ctx context.Context, id string, options GetItemsByIdInstantMixOperationOptions) (result GetItemsByIdInstantMixCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetItemsByIdInstantMixOperationResponse
		page, err = c.GetItemsByIdInstantMix(ctx, id, options)
