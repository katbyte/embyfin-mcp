...
// GetAudioByIdStreamOperationResponse is the result of GetAudioByIdStream.
//
// The operation answers audio/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetAudioByIdStreamOperationResponse struct {
	HttpResponse *http.Response
}

// GetAudioByIdStreamOperationOptions holds the query and header parameters of GetAudioByIdStream.
type GetAudioByIdStreamOperationOptions struct {
...
func (o GetAudioByIdStreamOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAudioByIdStreamOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetAudioByIdStream(ctx context.Context, id string, options GetAudioByIdStreamOperationOptions) (result GetAudioByIdStreamOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Audio/%s/stream", url.PathEscape(id)),
		StreamResponse: true,
	}
