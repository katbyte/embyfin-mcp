...
// GetVideosByIdMainM3u8OperationResponse is the result of GetVideosByIdMainM3u8.
//
// The operation answers application/x-mpegURL, left unread in HttpResponse.Body, which
// the caller must close.
type GetVideosByIdMainM3u8OperationResponse struct {
	HttpResponse *http.Response
}

// GetVideosByIdMainM3u8OperationOptions holds the query and header parameters of GetVideosByIdMainM3u8.
type GetVideosByIdMainM3u8OperationOptions struct {
...
func (o GetVideosByIdMainM3u8OperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetVideosByIdMainM3u8OperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetVideosByIdMainM3u8(ctx context.Context, id string, options GetVideosByIdMainM3u8OperationOptions) (result GetVideosByIdMainM3u8OperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Videos/%s/main.m3u8", url.PathEscape(id)),
		StreamResponse: true,
	}
