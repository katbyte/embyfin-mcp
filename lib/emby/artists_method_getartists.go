...
// GetArtistsOperationResponse is the result of GetArtists.
type GetArtistsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetArtistsOperationOptions holds the query and header parameters of GetArtists.
type GetArtistsOperationOptions struct {
...
func (o GetArtistsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetArtistsOperationOptions) ToQuery() *client.QueryParams {
...
// GetArtists calls GET /Artists. Gets all artists from a given item, folder, or the entire library.
func (c Client) GetArtists(ctx context.Context, options GetArtistsOperationOptions) (result GetArtistsOperationResponse, err error) {
...
// GetArtistsCompleteResult is every result GetArtistsComplete loaded.
type GetArtistsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetArtistsComplete calls GetArtists page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetArtistsComplete(ctx context.Context, options GetArtistsOperationOptions) (result GetArtistsCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetArtistsOperationResponse
		page, err = c.GetArtists(ctx, options)
