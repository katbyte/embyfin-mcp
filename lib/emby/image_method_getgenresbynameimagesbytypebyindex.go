...
// GetGenresByNameImagesByTypeByIndexOperationResponse is the result of GetGenresByNameImagesByTypeByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetGenresByNameImagesByTypeByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetGenresByNameImagesByTypeByIndexOperationOptions holds the query and header parameters of GetGenresByNameImagesByTypeByIndex.
type GetGenresByNameImagesByTypeByIndexOperationOptions struct {
...
func (o GetGenresByNameImagesByTypeByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetGenresByNameImagesByTypeByIndexOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetGenresByNameImagesByTypeByIndex(ctx context.Context, name string, typeParam ImageType, index int, options GetGenresByNameImagesByTypeByIndexOperationOptions) (result GetGenresByNameImagesByTypeByIndexOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Genres/%s/Images/%s/%d", url.PathEscape(name), url.PathEscape(string(typeParam)), index),
		StreamResponse: true,
	}
