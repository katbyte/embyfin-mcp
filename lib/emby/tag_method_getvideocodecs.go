...
// GetVideoCodecsOperationResponse is the result of GetVideoCodecs.
type GetVideoCodecsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetVideoCodecsOperationOptions holds the query and header parameters of GetVideoCodecs.
type GetVideoCodecsOperationOptions struct {
...
func (o GetVideoCodecsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetVideoCodecsOperationOptions) ToQuery() *client.QueryParams {
...
// GetVideoCodecs calls GET /VideoCodecs. Gets items based on a query.
func (c Client) GetVideoCodecs(ctx context.Context, options GetVideoCodecsOperationOptions) (result GetVideoCodecsOperationResponse, err error) {
...
// GetVideoCodecsCompleteResult is every result GetVideoCodecsComplete loaded.
type GetVideoCodecsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetVideoCodecsComplete calls GetVideoCodecs page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetVideoCodecsComplete(ctx context.Context, options GetVideoCodecsOperationOptions) (result GetVideoCodecsCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetVideoCodecsOperationResponse
		page, err = c.GetVideoCodecs(ctx, options)
