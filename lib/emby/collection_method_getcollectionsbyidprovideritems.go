...
// GetCollectionsByIdProviderItemsOperationResponse is the result of GetCollectionsByIdProviderItems.
type GetCollectionsByIdProviderItemsOperationResponse struct {
	HttpResponse *http.Response
	Model        json.RawMessage
}

// GetCollectionsByIdProviderItemsOperationOptions holds the query and header parameters of GetCollectionsByIdProviderItems.
type GetCollectionsByIdProviderItemsOperationOptions struct {
...
func (o GetCollectionsByIdProviderItemsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetCollectionsByIdProviderItemsOperationOptions) ToQuery() *client.QueryParams {
...
// GetCollectionsByIdProviderItems calls GET /Collections/{Id}/ProviderItems. Gets a list of missing items.
func (c Client) GetCollectionsByIdProviderItems(ctx context.Context, id string, options GetCollectionsByIdProviderItemsOperationOptions) (result GetCollectionsByIdProviderItemsOperationResponse, err error) {
