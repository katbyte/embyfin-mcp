...
func TestOperationGetVideosByIdAdditionalParts(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetVideosByIdAdditionalParts(t.Context(), "p/id", GetVideosByIdAdditionalPartsOperationOptions{
		UserId:           "v-UserId",
		Fields:           "v-Fields",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Videos/p%2Fid/AdditionalParts")
