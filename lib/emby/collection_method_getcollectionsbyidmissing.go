...
// GetCollectionsByIdMissingOperationResponse is the result of GetCollectionsByIdMissing.
type GetCollectionsByIdMissingOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetCollectionsByIdMissingOperationOptions holds the query and header parameters of GetCollectionsByIdMissing.
type GetCollectionsByIdMissingOperationOptions struct {
...
func (o GetCollectionsByIdMissingOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetCollectionsByIdMissingOperationOptions) ToQuery() *client.QueryParams {
...
// GetCollectionsByIdMissing calls GET /Collections/{Id}/Missing. Gets a list of missing items.
func (c Client) GetCollectionsByIdMissing(ctx context.Context, id string, options GetCollectionsByIdMissingOperationOptions) (result GetCollectionsByIdMissingOperationResponse, err error) {
...
// GetCollectionsByIdMissingCompleteResult is every result GetCollectionsByIdMissingComplete loaded.
type GetCollectionsByIdMissingCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetCollectionsByIdMissingComplete calls GetCollectionsByIdMissing page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetCollectionsByIdMissingComplete(ctx context.Context, id string, options GetCollectionsByIdMissingOperationOptions) (result GetCollectionsByIdMissingCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetCollectionsByIdMissingOperationResponse
		page, err = c.GetCollectionsByIdMissing(ctx, id, options)
