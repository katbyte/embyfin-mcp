...
// GetSongsByIdInstantMixOperationResponse is the result of GetSongsByIdInstantMix.
type GetSongsByIdInstantMixOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetSongsByIdInstantMixOperationOptions holds the query and header parameters of GetSongsByIdInstantMix.
type GetSongsByIdInstantMixOperationOptions struct {
...
func (o GetSongsByIdInstantMixOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetSongsByIdInstantMixOperationOptions) ToQuery() *client.QueryParams {
...
// GetSongsByIdInstantMix calls GET /Songs/{Id}/InstantMix. Creates an instant playlist based on a given song.
func (c Client) GetSongsByIdInstantMix(ctx context.Context, id string, options GetSongsByIdInstantMixOperationOptions) (result GetSongsByIdInstantMixOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Songs/%s/InstantMix", url.PathEscape(id)),
	}
...
// GetSongsByIdInstantMixCompleteResult is every result GetSongsByIdInstantMixComplete loaded.
type GetSongsByIdInstantMixCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetSongsByIdInstantMixComplete calls GetSongsByIdInstantMix page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetSongsByIdInstantMixComplete(ctx context.Context, id string, options GetSongsByIdInstantMixOperationOptions) (result GetSongsByIdInstantMixCompleteResult, err error) {
	...
	for {
		var page GetSongsByIdInstantMixOperationResponse
		page, err = c.GetSongsByIdInstantMix(ctx, id, options)
