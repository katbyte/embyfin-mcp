...
// GetArtistsAlbumArtistsOperationResponse is the result of GetArtistsAlbumArtists.
type GetArtistsAlbumArtistsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetArtistsAlbumArtistsOperationOptions holds the query and header parameters of GetArtistsAlbumArtists.
type GetArtistsAlbumArtistsOperationOptions struct {
...
func (o GetArtistsAlbumArtistsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetArtistsAlbumArtistsOperationOptions) ToQuery() *client.QueryParams {
...
// GetArtistsAlbumArtists calls GET /Artists/AlbumArtists. Gets all album artists from a given item, folder, or the entire library.
func (c Client) GetArtistsAlbumArtists(ctx context.Context, options GetArtistsAlbumArtistsOperationOptions) (result GetArtistsAlbumArtistsOperationResponse, err error) {
...
// GetArtistsAlbumArtistsCompleteResult is every result GetArtistsAlbumArtistsComplete loaded.
type GetArtistsAlbumArtistsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetArtistsAlbumArtistsComplete calls GetArtistsAlbumArtists page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetArtistsAlbumArtistsComplete(ctx context.Context, options GetArtistsAlbumArtistsOperationOptions) (result GetArtistsAlbumArtistsCompleteResult, err error) {
	...
	for {
		var page GetArtistsAlbumArtistsOperationResponse
		page, err = c.GetArtistsAlbumArtists(ctx, options)
