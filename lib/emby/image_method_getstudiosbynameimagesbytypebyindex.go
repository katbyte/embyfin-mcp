...
// GetStudiosByNameImagesByTypeByIndexOperationResponse is the result of GetStudiosByNameImagesByTypeByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetStudiosByNameImagesByTypeByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetStudiosByNameImagesByTypeByIndexOperationOptions holds the query and header parameters of GetStudiosByNameImagesByTypeByIndex.
type GetStudiosByNameImagesByTypeByIndexOperationOptions struct {
...
func (o GetStudiosByNameImagesByTypeByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetStudiosByNameImagesByTypeByIndexOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetStudiosByNameImagesByTypeByIndex(ctx context.Context, name string, typeParam ImageType, index int, options GetStudiosByNameImagesByTypeByIndexOperationOptions) (result GetStudiosByNameImagesByTypeByIndexOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Studios/%s/Images/%s/%d", url.PathEscape(name), url.PathEscape(string(typeParam)), index),
		StreamResponse: true,
	}
