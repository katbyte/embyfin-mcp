...
// GetVideosByIdMasterM3u8OperationResponse is the result of GetVideosByIdMasterM3u8.
//
// The operation answers application/x-mpegURL, left unread in HttpResponse.Body, which
// the caller must close.
type GetVideosByIdMasterM3u8OperationResponse struct {
	HttpResponse *http.Response
}

// GetVideosByIdMasterM3u8OperationOptions holds the query and header parameters of GetVideosByIdMasterM3u8.
type GetVideosByIdMasterM3u8OperationOptions struct {
...
func (o GetVideosByIdMasterM3u8OperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetVideosByIdMasterM3u8OperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetVideosByIdMasterM3u8(ctx context.Context, id string, options GetVideosByIdMasterM3u8OperationOptions) (result GetVideosByIdMasterM3u8OperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Videos/%s/master.m3u8", url.PathEscape(id)),
		StreamResponse: true,
	}
