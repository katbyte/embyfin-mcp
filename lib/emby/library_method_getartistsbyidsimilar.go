...
// GetArtistsByIdSimilarOperationResponse is the result of GetArtistsByIdSimilar.
type GetArtistsByIdSimilarOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetArtistsByIdSimilarOperationOptions holds the query and header parameters of GetArtistsByIdSimilar.
type GetArtistsByIdSimilarOperationOptions struct {
...
func (o GetArtistsByIdSimilarOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetArtistsByIdSimilarOperationOptions) ToQuery() *client.QueryParams {
...
// GetArtistsByIdSimilar calls GET /Artists/{Id}/Similar. Finds albums similar to a given album.
func (c Client) GetArtistsByIdSimilar(ctx context.Context, id string, options GetArtistsByIdSimilarOperationOptions) (result GetArtistsByIdSimilarOperationResponse, err error) {
...
// GetArtistsByIdSimilarCompleteResult is every result GetArtistsByIdSimilarComplete loaded.
type GetArtistsByIdSimilarCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetArtistsByIdSimilarComplete calls GetArtistsByIdSimilar page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetArtistsByIdSimilarComplete(ctx context.Context, id string, options GetArtistsByIdSimilarOperationOptions) (result GetArtistsByIdSimilarCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetArtistsByIdSimilarOperationResponse
		page, err = c.GetArtistsByIdSimilar(ctx, id, options)
