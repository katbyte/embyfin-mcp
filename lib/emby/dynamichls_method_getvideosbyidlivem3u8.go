...
// GetVideosByIdLiveM3u8OperationResponse is the result of GetVideosByIdLiveM3u8.
//
// The operation answers application/x-mpegURL, left unread in HttpResponse.Body, which
// the caller must close.
type GetVideosByIdLiveM3u8OperationResponse struct {
	HttpResponse *http.Response
}

// GetVideosByIdLiveM3u8OperationOptions holds the query and header parameters of GetVideosByIdLiveM3u8.
type GetVideosByIdLiveM3u8OperationOptions struct {
...
func (o GetVideosByIdLiveM3u8OperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetVideosByIdLiveM3u8OperationOptions) ToQuery() *client.QueryParams {
