...
// GetUsersByIdImagesByTypeOperationResponse is the result of GetUsersByIdImagesByType.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetUsersByIdImagesByTypeOperationResponse struct {
	HttpResponse *http.Response
}

// GetUsersByIdImagesByTypeOperationOptions holds the query and header parameters of GetUsersByIdImagesByType.
type GetUsersByIdImagesByTypeOperationOptions struct {
...
func (o GetUsersByIdImagesByTypeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetUsersByIdImagesByTypeOperationOptions) ToQuery() *client.QueryParams {
