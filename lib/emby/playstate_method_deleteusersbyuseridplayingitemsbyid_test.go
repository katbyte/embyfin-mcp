...
func TestOperationDeleteUsersByUserIdPlayingItemsById(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "", "")
	result, err := c.DeleteUsersByUserIdPlayingItemsById(t.Context(), "p/userId", "p/id", DeleteUsersByUserIdPlayingItemsByIdOperationOptions{
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodDelete, "/Users/p%2FuserId/PlayingItems/p%2Fid")
