...
// GetGameGenresByNameImagesByTypeByIndexOperationResponse is the result of GetGameGenresByNameImagesByTypeByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetGameGenresByNameImagesByTypeByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetGameGenresByNameImagesByTypeByIndexOperationOptions holds the query and header parameters of GetGameGenresByNameImagesByTypeByIndex.
type GetGameGenresByNameImagesByTypeByIndexOperationOptions struct {
...
func (o GetGameGenresByNameImagesByTypeByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetGameGenresByNameImagesByTypeByIndexOperationOptions) ToQuery() *client.QueryParams {
