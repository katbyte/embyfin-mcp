...
func TestOperationGetUsersByIdImagesByTypeByIndex(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "image/png", "file bytes")
	result, err := c.GetUsersByIdImagesByTypeByIndex(t.Context(), "p/id", ImageTypePrimary, 7, GetUsersByIdImagesByTypeByIndexOperationOptions{
		MaxWidth:             7,
		MaxHeight:            7,
		Width:                7,
		Height:               7,
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Users/p%2Fid/Images/Primary/7")
