...
func TestOperationPostPlaylists(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.PostPlaylists(t.Context(), PostPlaylistsOperationOptions{
		Name:      "v-Name",
		Ids:       "v-Ids",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodPost, "/Playlists")
	expectQuery(t, r, "Name", "v-Name")
	expectQuery(t, r, "Ids", "v-Ids")
	expectQuery(t, r, "MediaType", "v-MediaType")
