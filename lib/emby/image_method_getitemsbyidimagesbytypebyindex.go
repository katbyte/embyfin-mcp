...
// GetItemsByIdImagesByTypeByIndexOperationResponse is the result of GetItemsByIdImagesByTypeByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetItemsByIdImagesByTypeByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetItemsByIdImagesByTypeByIndexOperationOptions holds the query and header parameters of GetItemsByIdImagesByTypeByIndex.
type GetItemsByIdImagesByTypeByIndexOperationOptions struct {
...
func (o GetItemsByIdImagesByTypeByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemsByIdImagesByTypeByIndexOperationOptions) ToQuery() *client.QueryParams {
