...
// GetUsersByUserIdItemsResumeOperationResponse is the result of GetUsersByUserIdItemsResume.
type GetUsersByUserIdItemsResumeOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetUsersByUserIdItemsResumeOperationOptions holds the query and header parameters of GetUsersByUserIdItemsResume.
type GetUsersByUserIdItemsResumeOperationOptions struct {
...
func (o GetUsersByUserIdItemsResumeOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetUsersByUserIdItemsResumeOperationOptions) ToQuery() *client.QueryParams {
...
// GetUsersByUserIdItemsResume calls GET /Users/{UserId}/Items/Resume. Gets items based on a query.
func (c Client) GetUsersByUserIdItemsResume(ctx context.Context, userId string, options GetUsersByUserIdItemsResumeOperationOptions) (result GetUsersByUserIdItemsResumeOperationResponse, err error) {
...
// GetUsersByUserIdItemsResumeCompleteResult is every result GetUsersByUserIdItemsResumeComplete loaded.
type GetUsersByUserIdItemsResumeCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetUsersByUserIdItemsResumeComplete calls GetUsersByUserIdItemsResume page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetUsersByUserIdItemsResumeComplete(ctx context.Context, userId string, options GetUsersByUserIdItemsResumeOperationOptions) (result GetUsersByUserIdItemsResumeCompleteResult, err error) {
	...
	for {
		var page GetUsersByUserIdItemsResumeOperationResponse
		page, err = c.GetUsersByUserIdItemsResume(ctx, userId, options)
