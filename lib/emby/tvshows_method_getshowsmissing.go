...
// GetShowsMissingOperationResponse is the result of GetShowsMissing.
type GetShowsMissingOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetShowsMissingOperationOptions holds the query and header parameters of GetShowsMissing.
type GetShowsMissingOperationOptions struct {
...
func (o GetShowsMissingOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetShowsMissingOperationOptions) ToQuery() *client.QueryParams {
...
// GetShowsMissing calls GET /Shows/Missing. Gets a list of missing episodes.
func (c Client) GetShowsMissing(ctx context.Context, options GetShowsMissingOperationOptions) (result GetShowsMissingOperationResponse, err error) {
...
// GetShowsMissingCompleteResult is every result GetShowsMissingComplete loaded.
type GetShowsMissingCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetShowsMissingComplete calls GetShowsMissing page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetShowsMissingComplete(ctx context.Context, options GetShowsMissingOperationOptions) (result GetShowsMissingCompleteResult, err error) {
	...
	for {
		var page GetShowsMissingOperationResponse
		page, err = c.GetShowsMissing(ctx, options)
