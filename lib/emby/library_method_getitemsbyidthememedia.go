...
// GetItemsByIdThemeMediaOperationResponse is the result of GetItemsByIdThemeMedia.
type GetItemsByIdThemeMediaOperationResponse struct {
	HttpResponse *http.Response
	Model        *AllThemeMediaResult
}

// GetItemsByIdThemeMediaOperationOptions holds the query and header parameters of GetItemsByIdThemeMedia.
type GetItemsByIdThemeMediaOperationOptions struct {
...
func (o GetItemsByIdThemeMediaOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemsByIdThemeMediaOperationOptions) ToQuery() *client.QueryParams {
...
// GetItemsByIdThemeMedia calls GET /Items/{Id}/ThemeMedia. Gets theme videos and songs for an item.
func (c Client) GetItemsByIdThemeMedia(ctx context.Context, id string, options GetItemsByIdThemeMediaOperationOptions) (result GetItemsByIdThemeMediaOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("/Items/%s/ThemeMedia", url.PathEscape(id)),
	}
