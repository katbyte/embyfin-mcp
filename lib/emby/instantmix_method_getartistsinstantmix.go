...
// GetArtistsInstantMixOperationResponse is the result of GetArtistsInstantMix.
type GetArtistsInstantMixOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetArtistsInstantMixOperationOptions holds the query and header parameters of GetArtistsInstantMix.
type GetArtistsInstantMixOperationOptions struct {
	...
	// The artist the mix is made from
	Id string
}

// ToHeaders returns the header parameters the options set.
func (o GetArtistsInstantMixOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetArtistsInstantMixOperationOptions) ToQuery() *client.QueryParams {
...
// GetArtistsInstantMix calls GET /Artists/InstantMix. Creates an instant playlist based on a given artist.
func (c Client) GetArtistsInstantMix(ctx context.Context, options GetArtistsInstantMixOperationOptions) (result GetArtistsInstantMixOperationResponse, err error) {
...
// GetArtistsInstantMixCompleteResult is every result GetArtistsInstantMixComplete loaded.
type GetArtistsInstantMixCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetArtistsInstantMixComplete calls GetArtistsInstantMix page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetArtistsInstantMixComplete(ctx context.Context, options GetArtistsInstantMixOperationOptions) (result GetArtistsInstantMixCompleteResult, err error) {
	...
	for {
		var page GetArtistsInstantMixOperationResponse
		page, err = c.GetArtistsInstantMix(ctx, options)
