...
// GetLiveTvProgramsRecommendedOperationResponse is the result of GetLiveTvProgramsRecommended.
type GetLiveTvProgramsRecommendedOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetLiveTvProgramsRecommendedOperationOptions holds the query and header parameters of GetLiveTvProgramsRecommended.
type GetLiveTvProgramsRecommendedOperationOptions struct {
...
func (o GetLiveTvProgramsRecommendedOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetLiveTvProgramsRecommendedOperationOptions) ToQuery() *client.QueryParams {
...
// GetLiveTvProgramsRecommended calls GET /LiveTv/Programs/Recommended. Gets available live tv epgs..
func (c Client) GetLiveTvProgramsRecommended(ctx context.Context, options GetLiveTvProgramsRecommendedOperationOptions) (result GetLiveTvProgramsRecommendedOperationResponse, err error) {
...
// GetLiveTvProgramsRecommendedCompleteResult is every result GetLiveTvProgramsRecommendedComplete loaded.
type GetLiveTvProgramsRecommendedCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetLiveTvProgramsRecommendedComplete calls GetLiveTvProgramsRecommended page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetLiveTvProgramsRecommendedComplete(ctx context.Context, options GetLiveTvProgramsRecommendedOperationOptions) (result GetLiveTvProgramsRecommendedCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetLiveTvProgramsRecommendedOperationResponse
		page, err = c.GetLiveTvProgramsRecommended(ctx, options)
