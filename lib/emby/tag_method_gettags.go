...
// GetTagsOperationResponse is the result of GetTags.
type GetTagsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetTagsOperationOptions holds the query and header parameters of GetTags.
type GetTagsOperationOptions struct {
...
func (o GetTagsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetTagsOperationOptions) ToQuery() *client.QueryParams {
...
// GetTags calls GET /Tags. Gets items based on a query.
func (c Client) GetTags(ctx context.Context, options GetTagsOperationOptions) (result GetTagsOperationResponse, err error) {
...
// GetTagsCompleteResult is every result GetTagsComplete loaded.
type GetTagsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetTagsComplete calls GetTags page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetTagsComplete(ctx context.Context, options GetTagsOperationOptions) (result GetTagsCompleteResult, err error) {
	...
	for {
		var page GetTagsOperationResponse
		page, err = c.GetTags(ctx, options)
