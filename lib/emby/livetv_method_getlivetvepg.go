...
// GetLiveTvEPGOperationResponse is the result of GetLiveTvEPG.
type GetLiveTvEPGOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultApiEpgRow
}

// GetLiveTvEPGOperationOptions holds the query and header parameters of GetLiveTvEPG.
type GetLiveTvEPGOperationOptions struct {
...
func (o GetLiveTvEPGOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetLiveTvEPGOperationOptions) ToQuery() *client.QueryParams {
	...
	if o.ChannelIds != "" {
		out.Append("ChannelIds", o.ChannelIds)
	}
	if o.ArtistType != "" {
...
// GetLiveTvEPG calls GET /LiveTv/EPG. Gets the epg.
func (c Client) GetLiveTvEPG(ctx context.Context, options GetLiveTvEPGOperationOptions) (result GetLiveTvEPGOperationResponse, err error) {
	...
	var model QueryResultApiEpgRow
	result.Model = &model
...
// GetLiveTvEPGCompleteResult is every result GetLiveTvEPGComplete loaded.
type GetLiveTvEPGCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []ApiEpgRow
}

// GetLiveTvEPGComplete calls GetLiveTvEPG page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetLiveTvEPGComplete(ctx context.Context, options GetLiveTvEPGOperationOptions) (result GetLiveTvEPGCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetLiveTvEPGOperationResponse
		page, err = c.GetLiveTvEPG(ctx, options)
