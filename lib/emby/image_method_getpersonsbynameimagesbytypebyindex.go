...
// GetPersonsByNameImagesByTypeByIndexOperationResponse is the result of GetPersonsByNameImagesByTypeByIndex.
//
// The operation answers image/*, left unread in HttpResponse.Body, which
// the caller must close.
type GetPersonsByNameImagesByTypeByIndexOperationResponse struct {
	HttpResponse *http.Response
}

// GetPersonsByNameImagesByTypeByIndexOperationOptions holds the query and header parameters of GetPersonsByNameImagesByTypeByIndex.
type GetPersonsByNameImagesByTypeByIndexOperationOptions struct {
...
func (o GetPersonsByNameImagesByTypeByIndexOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetPersonsByNameImagesByTypeByIndexOperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetPersonsByNameImagesByTypeByIndex(ctx context.Context, name string, typeParam ImageType, index int, options GetPersonsByNameImagesByTypeByIndexOperationOptions) (result GetPersonsByNameImagesByTypeByIndexOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Persons/%s/Images/%s/%d", url.PathEscape(name), url.PathEscape(string(typeParam)), index),
		StreamResponse: true,
	}
