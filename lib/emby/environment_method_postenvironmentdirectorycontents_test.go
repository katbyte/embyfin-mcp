...
func TestOperationPostEnvironmentDirectoryContents(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "[{}]")
	result, err := c.PostEnvironmentDirectoryContents(t.Context(), GetDirectoryContents{}, PostEnvironmentDirectoryContentsOperationOptions{
		Path:               "v-Path",
