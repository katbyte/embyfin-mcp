...
// GetLiveTvRecordingsOperationResponse is the result of GetLiveTvRecordings.
type GetLiveTvRecordingsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetLiveTvRecordingsOperationOptions holds the query and header parameters of GetLiveTvRecordings.
type GetLiveTvRecordingsOperationOptions struct {
...
func (o GetLiveTvRecordingsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetLiveTvRecordingsOperationOptions) ToQuery() *client.QueryParams {
...
// GetLiveTvRecordings calls GET /LiveTv/Recordings. Gets live tv recordings.
func (c Client) GetLiveTvRecordings(ctx context.Context, options GetLiveTvRecordingsOperationOptions) (result GetLiveTvRecordingsOperationResponse, err error) {
...
// GetLiveTvRecordingsCompleteResult is every result GetLiveTvRecordingsComplete loaded.
type GetLiveTvRecordingsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetLiveTvRecordingsComplete calls GetLiveTvRecordings page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetLiveTvRecordingsComplete(ctx context.Context, options GetLiveTvRecordingsOperationOptions) (result GetLiveTvRecordingsCompleteResult, err error) {
	...
	for {
		var page GetLiveTvRecordingsOperationResponse
		page, err = c.GetLiveTvRecordings(ctx, options)
