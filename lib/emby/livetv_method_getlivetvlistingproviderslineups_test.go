...
func TestOperationGetLiveTvListingProvidersLineups(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "[{}]")
	result, err := c.GetLiveTvListingProvidersLineups(t.Context(), GetLiveTvListingProvidersLineupsOperationOptions{
		Id:       "v-Id",
		Type:     "v-Type",
		Location: "v-Location",
		Country:  "v-Country",
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/LiveTv/ListingProviders/Lineups")
	expectQuery(t, r, "Id", "v-Id")
	expectQuery(t, r, "Type", "v-Type")
	expectQuery(t, r, "Location", "v-Location")
	expectQuery(t, r, "Country", "v-Country")
