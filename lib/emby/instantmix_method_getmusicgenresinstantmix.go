...
// GetMusicGenresInstantMixOperationResponse is the result of GetMusicGenresInstantMix.
type GetMusicGenresInstantMixOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultBaseItemDto
}

// GetMusicGenresInstantMixOperationOptions holds the query and header parameters of GetMusicGenresInstantMix.
type GetMusicGenresInstantMixOperationOptions struct {
...
func (o GetMusicGenresInstantMixOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetMusicGenresInstantMixOperationOptions) ToQuery() *client.QueryParams {
...
// GetMusicGenresInstantMix calls GET /MusicGenres/InstantMix. Creates an instant playlist based on a music genre.
func (c Client) GetMusicGenresInstantMix(ctx context.Context, options GetMusicGenresInstantMixOperationOptions) (result GetMusicGenresInstantMixOperationResponse, err error) {
...
// GetMusicGenresInstantMixCompleteResult is every result GetMusicGenresInstantMixComplete loaded.
type GetMusicGenresInstantMixCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetMusicGenresInstantMixComplete calls GetMusicGenresInstantMix page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetMusicGenresInstantMixComplete(ctx context.Context, options GetMusicGenresInstantMixOperationOptions) (result GetMusicGenresInstantMixCompleteResult, err error) {
	...
	for {
		var page GetMusicGenresInstantMixOperationResponse
		page, err = c.GetMusicGenresInstantMix(ctx, options)
