...
// GetStreamLanguagesOperationResponse is the result of GetStreamLanguages.
type GetStreamLanguagesOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetStreamLanguagesOperationOptions holds the query and header parameters of GetStreamLanguages.
type GetStreamLanguagesOperationOptions struct {
...
func (o GetStreamLanguagesOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetStreamLanguagesOperationOptions) ToQuery() *client.QueryParams {
...
// GetStreamLanguages calls GET /StreamLanguages. Gets items based on a query.
func (c Client) GetStreamLanguages(ctx context.Context, options GetStreamLanguagesOperationOptions) (result GetStreamLanguagesOperationResponse, err error) {
...
// GetStreamLanguagesCompleteResult is every result GetStreamLanguagesComplete loaded.
type GetStreamLanguagesCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetStreamLanguagesComplete calls GetStreamLanguages page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetStreamLanguagesComplete(ctx context.Context, options GetStreamLanguagesOperationOptions) (result GetStreamLanguagesCompleteResult, err error) {
	...
	for {
		var page GetStreamLanguagesOperationResponse
		page, err = c.GetStreamLanguages(ctx, options)
