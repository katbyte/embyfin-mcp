...
// GetAudioLayoutsOperationResponse is the result of GetAudioLayouts.
type GetAudioLayoutsOperationResponse struct {
	HttpResponse *http.Response
	Model        *QueryResultUserLibraryTagItem
}

// GetAudioLayoutsOperationOptions holds the query and header parameters of GetAudioLayouts.
type GetAudioLayoutsOperationOptions struct {
...
func (o GetAudioLayoutsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAudioLayoutsOperationOptions) ToQuery() *client.QueryParams {
...
// GetAudioLayouts calls GET /AudioLayouts. Gets items based on a query.
func (c Client) GetAudioLayouts(ctx context.Context, options GetAudioLayoutsOperationOptions) (result GetAudioLayoutsOperationResponse, err error) {
...
// GetAudioLayoutsCompleteResult is every result GetAudioLayoutsComplete loaded.
type GetAudioLayoutsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []UserLibraryTagItem
}

// GetAudioLayoutsComplete calls GetAudioLayouts page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetAudioLayoutsComplete(ctx context.Context, options GetAudioLayoutsOperationOptions) (result GetAudioLayoutsCompleteResult, err error) {
	if options.Limit <= 0 {
		options.Limit = client.DefaultPageSize
	}
	for {
		var page GetAudioLayoutsOperationResponse
		page, err = c.GetAudioLayouts(ctx, options)
