...
// GetItemsByIdThemeSongsOperationResponse is the result of GetItemsByIdThemeSongs.
type GetItemsByIdThemeSongsOperationResponse struct {
	HttpResponse *http.Response
	Model        *ThemeMediaResult
}

// GetItemsByIdThemeSongsOperationOptions holds the query and header parameters of GetItemsByIdThemeSongs.
type GetItemsByIdThemeSongsOperationOptions struct {
...
func (o GetItemsByIdThemeSongsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetItemsByIdThemeSongsOperationOptions) ToQuery() *client.QueryParams {
...
// GetItemsByIdThemeSongs calls GET /Items/{Id}/ThemeSongs. Gets theme songs for an item.
func (c Client) GetItemsByIdThemeSongs(ctx context.Context, id string, options GetItemsByIdThemeSongsOperationOptions) (result GetItemsByIdThemeSongsOperationResponse, err error) {
...
// GetItemsByIdThemeSongsCompleteResult is every result GetItemsByIdThemeSongsComplete loaded.
type GetItemsByIdThemeSongsCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []BaseItemDto
}

// GetItemsByIdThemeSongsComplete calls GetItemsByIdThemeSongs page by page from options.StartIndex until every
// result is loaded. options.Limit is the page size, client.DefaultPageSize when
// unset.
func (c Client) GetItemsByIdThemeSongsComplete(ctx context.Context, id string, options GetItemsByIdThemeSongsOperationOptions) (result GetItemsByIdThemeSongsCompleteResult, err error) {
	...
	for {
		var page GetItemsByIdThemeSongsOperationResponse
		page, err = c.GetItemsByIdThemeSongs(ctx, id, options)
