...
func TestOperationGetPlaylistsByIdAddToPlaylistInfo(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "{}")
	result, err := c.GetPlaylistsByIdAddToPlaylistInfo(t.Context(), "p/id", GetPlaylistsByIdAddToPlaylistInfoOperationOptions{
		UserId: "v-UserId",
		Ids:    "v-Ids",
	})
	if err != nil {
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/Playlists/p%2Fid/AddToPlaylistInfo")
