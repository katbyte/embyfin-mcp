...
// GetAudioByIdLiveM3u8OperationResponse is the result of GetAudioByIdLiveM3u8.
//
// The operation answers application/x-mpegURL, left unread in HttpResponse.Body, which
// the caller must close.
type GetAudioByIdLiveM3u8OperationResponse struct {
	HttpResponse *http.Response
}

// GetAudioByIdLiveM3u8OperationOptions holds the query and header parameters of GetAudioByIdLiveM3u8.
type GetAudioByIdLiveM3u8OperationOptions struct {
...
func (o GetAudioByIdLiveM3u8OperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
	return &out
}

// ToQuery returns the query parameters the options set.
func (o GetAudioByIdLiveM3u8OperationOptions) ToQuery() *client.QueryParams {
...
func (c Client) GetAudioByIdLiveM3u8(ctx context.Context, id string, options GetAudioByIdLiveM3u8OperationOptions) (result GetAudioByIdLiveM3u8OperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:           fmt.Sprintf("/Audio/%s/live.m3u8", url.PathEscape(id)),
		StreamResponse: true,
	}
