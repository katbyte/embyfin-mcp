...
func TestOperationDeleteUsersByIdImagesByType(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "", "")
	result, err := c.DeleteUsersByIdImagesByType(t.Context(), "p/id", ImageTypePrimary, DeleteUsersByIdImagesByTypeOperationOptions{
		Index: 7,
	})
	if err != nil {
		t.Fatal(err)
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodDelete, "/Users/p%2Fid/Images/Primary")
