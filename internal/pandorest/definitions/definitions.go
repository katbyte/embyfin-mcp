...
type Operation struct {
	...
	// Pageable is set for StartIndex/Limit list operations, which also get
	// a Complete method that pages through every result.
...
type Pageable struct {
	// StartIndexOption and LimitOption are the options fields.
	StartIndexOption string `json:"StartIndexOption"`
	LimitOption      string `json:"LimitOption"`
	// ItemsField and TotalField are fields of the response model.
